 ...
 *   https://datatables.net/download/#bs5/dt-2.0.7/e-2.3.2/b-3.0.2/date-1.5.2/sl-2.0.1
 *
 * Included libraries:
 *   DataTables 2.0.7, Editor 2.3.2, Buttons 3.0.2, DateTime 1.5.2, Select 2.0.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.0.7/e-2.3.2/b-3.0.2/date-1.5.2/sl-2.0.1",
